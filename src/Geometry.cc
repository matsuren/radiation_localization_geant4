...
//   logVol_World->SetVisAttributes (G4VisAttributes::Invisible);
    ...
    G4Box *solid_detector = new G4Box("Solid_detector", leng_X_detector / 2.0, leng_Y_detector / 2.0,
                                      leng_Z_detector / 2.0);
    ...
    G4LogicalVolume *logVol_detector =
            new G4LogicalVolume(solid_detector, materi_detector, "LogVol_detector", 0, 0, 0);
