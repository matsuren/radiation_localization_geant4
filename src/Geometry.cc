...
//   logVol_World->SetVisAttributes (G4VisAttributes::Invisible);
   ...
   // Define 'BGO Detector'
   // Define the shape of solid
    G4double leng_X_detector = 3.0*cm;
    G4double leng_Y_detector = 3.0*cm;
    G4double leng_Z_detector = 3.0*cm;
    G4Box* solid_BGO = new G4Box("Solid_BGO", leng_X_detector/2.0, leng_Y_detector/2.0, leng_Z_detector/2.0);
